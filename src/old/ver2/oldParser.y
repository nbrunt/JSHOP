...
command
    ...
    | IF expression blockCmds elsifs optelse
        { CmdIf {ciCondThens = ($2,$3) : $4, ciElse = $5, cmdSrcPos = $1} }
...
elsifs : {- epsilon -}
           { [] }
       | ELSE IF expression blockCmds elsifs
           { ($3,$4) : $5 }
...
-- | Parses a JavaScript program, building an AST representation of it
-- if successful.
